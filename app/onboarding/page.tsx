...
const slides: Slide[] = [
  {
    ...
    subtitle:
      'Ассистент помогает превратить большую цель в понятный план и каждый день держать фокус на главном.',
  },
  {
    id: 'pyramid',
    badge: 'Структура',
    ...
    subtitle:
      'Куратор помогает разложить мечту на понятные этапы — от года до недели. Так большая цель превращается в рабочий план.',
  },
  {
    id: 'rhythm',
    ...
    title: (
      <>
        Помощник: ежедневное планирование
        <br />
        <span className="onb-gradient-text">и оценка дня</span>
      </>
    ),
    subtitle:
      'Советник помогает собрать и согласовать план с вашими целями, убрать перегруз и выделить главное. Оценка результата показывает, насколько этот день действительно приблизил вас к цели.',
  },
  {
    id: 'profile',
    badge: 'Профиль',
  ...
  },
  {
    ...
    subtitle:
      'После кнопки Начать вы попадёте в профиль. Расскажите о себе, затем задайте мечту, и Гид поможет превратить её в рабочий план по периодам.',
  },
]
...
function RhythmVisual() {
  const steps = [
    { time: 'Начало', text: 'Создайте и согласуйте план с Помощником', color: 'border-purple-400/40' },

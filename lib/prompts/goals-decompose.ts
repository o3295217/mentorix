...
1. Следующий месяц (${MONTH_NAMES[nextMonth]} ${nextMonthYear}) → ВСЕГДА 4 недели (W1, W2, W3, W4). Текущая неделя НЕ учитывается — план начинается с первой недели следующего месяца.
${isEndOfMonth ? `2. Месяц после следующего → тоже по неделям (упреждающее раскрытие)
...
- 3 мес: 4 недели следующего месяца + 2 месяца
- 6 мес: 4 недели + месяцы + 1 квартал
- 12 мес: 4 недели + месяцы + кварталы (до конца года)
- 18 мес: 4 недели + месяцы + кварталы + полугодие
- 24 мес: 4 недели + месяцы + кварталы + 2 полугодия
- 3 года: 4 недели + месяцы + кварталы + полугодия + 1 год
- 5+ лет: 4 недели + месяцы + кварталы + полугодия + годы
...
[WEEK:2026-04-W1] — первая неделя апреля
...
5. Если карта целей пустая — строй план: 4 недели следующего месяца, затем месяцы, кварталы, полугодия и годы — в зависимости от горизонта

...
- Хорошо: "Описать техническую архитектуру: выбрать между cloud (VK Cloud) и on-premise, нарисовать диаграмму компонентов, определить стоимость инфраструктуры на 12 месяцев"

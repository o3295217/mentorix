  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="text-center mb-6">
        ...
        <div className="text-lg text-gray-500">{forecast.unit}</div>
        
        {/* Сравнение с планом */}
        <div className="mt-3 flex items-center justify-center gap-3">
          <div className="text-sm text-gray-400">
            План: <span className="font-semibold text-gray-600">{targetYears} лет</span>
          </div>
          <div 
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-4">
        <div className="flex items-center justify-between mb-3">
          <span className="text-sm text-gray-500">Текущая скорость</span>
        ...
        <div className="relative mb-2">
          ...
          {neededSpeed > 0 && neededSpeed <= 10 && (
            <div 
              className="absolute top-1/2 w-0.5 h-5 bg-gray-800 rounded"
              style={{ 
        ...
        {diffYears > 0 && neededSpeed <= 10 && (
          <div className="mt-3 pt-3 border-t border-gray-100 text-center">
            <span className="text-xs text-gray-500">
              ...
              <span className="font-bold text-gray-700">{neededSpeed.toFixed(1)}</span>
            </span>
          </div>
        )}
      </div>
      ...
      <div className="bg-gray-50 rounded-xl p-3">
        <div className="flex justify-between text-xs mb-1.5">
          <span className="text-gray-500">Прогресс к мечте</span>
          <span className="font-medium text-gray-700">{productiveDays} / {targetDays} дней</span>
        </div>
        ...
        <div className="text-right text-xs text-gray-400 mt-1">{progressPercent.toFixed(1)}%</div>
      </div>
    </div>
  )
}

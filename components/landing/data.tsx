export const DAY_FLOW_STEPS = [
  {
    time: 'План',
    title: 'Собери день',
    desc: 'Ассистент помогает собрать план из шагов, которые действительно ведут к цели.',
    accent: 'purple',
  },
  {
    time: 'Фокус',
  ...
  },
  {
    ...
    desc: 'Советник оценивает день и подсказывает, как двигаться дальше, чтобы не терять направление.',
    accent: 'green',
  },
] as const
...
export const TRUST_PILLARS = [
  ...
  },
  {
    ...
    desc: 'Советник не лента и не витрина. Это спокойное личное пространство для целей, планов и честного разбора дня.',
    accent: 'amber',
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  {
    title: 'Понятная роль Ментора',
    desc: 'mentorix — умный ассистент Ментор. Он не решает за вас, а помогает держать связь между целью, днём и обратной связью.',
    accent: 'violet',
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>

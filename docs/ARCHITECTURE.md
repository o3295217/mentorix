...
model ChatMessage {
  ...
  content   String
  metadataJson Json?  // encrypted, typed cards (daily_schedule_proposal v1/v2/v3: currentScheduleExists/currentScheduleHash/currentPlanTaskCount/currentPlanTasksHash/proposal/loadSummary/appliedAt)
  createdAt DateTime @default(now())
}

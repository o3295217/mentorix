/*
  ...
  - Added the required column `fieldName` to the `profile_items` table without a default value. This is not possible if the table is not empty.
  - Added the required column `fieldValue` to the `profile_items` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "daily_entries" ADD COLUMN "emotionalState" TEXT;
ALTER TABLE "daily_entries" ADD COLUMN "energyLevel" INTEGER;
ALTER TABLE "daily_entries" ADD COLUMN "exerciseTime" INTEGER;
ALTER TABLE "daily_entries" ADD COLUMN "externalFactors" TEXT;
ALTER TABLE "daily_entries" ADD COLUMN "familyTime" INTEGER;
ALTER TABLE "daily_entries" ADD COLUMN "lifeEvents" TEXT;
ALTER TABLE "daily_entries" ADD COLUMN "physicalState" TEXT;
ALTER TABLE "daily_entries" ADD COLUMN "selectedTasksJson" TEXT;
ALTER TABLE "daily_entries" ADD COLUMN "sleepQuality" INTEGER;
...
CREATE INDEX "evaluations_dreamProgressScore_idx" ON "evaluations"("dreamProgressScore");
...
-- CreateIndex
CREATE INDEX "goals_periodType_periodKey_completed_idx" ON "goals"("periodType", "periodKey", "completed");
...
-- CreateIndex
CREATE INDEX "habits_isActive_sortOrder_idx" ON "habits"("isActive", "sortOrder");

-- CreateIndex
CREATE INDEX "open_tasks_isClosed_idx" ON "open_tasks"("isClosed");

-- CreateIndex
CREATE INDEX "open_tasks_taskType_isClosed_idx" ON "open_tasks"("taskType", "isClosed");

-- CreateIndex
CREATE INDEX "period_goals_periodType_periodStart_idx" ON "period_goals"("periodType", "periodStart");
